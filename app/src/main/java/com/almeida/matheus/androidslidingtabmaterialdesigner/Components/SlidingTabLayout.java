...
package com.almeida.matheus.androidslidingtabmaterialdesigner.Components;
 ...
 * <p>
 * The views used as tabs can be customized by calling {@link (int, int)},
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     */
    public void setCustomTabView(int layoutResId, int textViewId, int mTabIcon) {
    ...
    protected ImageView createDefaultTabView(Context context) {
        ...
        iconTab.setLayoutParams(new LinearLayout.LayoutParams(
